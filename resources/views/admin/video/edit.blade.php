...
@section('header')
<title>Admin | Endre video</title>
@stop

@section('content')

    <form method="POST" action="/admin/video/{{$youtube->id}}">
    <div class="row">       
        <div class="col-md-6 col-md-offset-3">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <input type="text" name="ytTitle" value="{{ $youtube->ytTitle }}" style="width:100%;" />
                </div>
            </div>
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <input type="text" name="ytVideoLink" value="{{ $youtube->ytVideoLink }}" style="width:100%;" />
                </div>
            </div>
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <input type="text" name="ytBackgroundLink" value="{{ $youtube->ytBackgroundLink }}" style="width:100%;" />
                </div>
            </div>
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <textarea name="ytDescription" style="width:100%;">{{ $youtube->ytDescription }} </textarea>
                </div>
            </div>
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    @if($youtube->ytHighlighted == 1)
                        <input type="checkbox" name="ytHighlighted" value="1" checked />
                    @else 
